...
import { getSustainabilityRecommendations } from "@/services/sustainability";
          ...
          >
            ...
            >
              {loading ? (
                ...
                <>
                  <Search className="h-4 w-4" /> Start Analysis
                </>
              )}
            </Button>
          </form>
